...
- Add a dark theme CSS variable fallback for system dark mode before `data-bezier-theme` is set. ([#2845](https://github.com/channel-io/bezier-react/pull/2845)) by @timok1m
