...
- Correct beta SettingsField spacing around field content and dividers. ([#2897](https://github.com/channel-io/bezier-react/pull/2897)) by @timok1m
...
- Add v3 atomic primitive components: `Box`, `Divider`, `Spinner`, `Text`, `HStack`, `VStack`, `Icon`, and `SmoothCornersBox`. ([#2830](https://github.com/channel-io/bezier-react/pull/2830)) by @timok1m
...
- Adjust CSS specificity to ensure Japanese font is properly applied - specify font family explicitly ([#2778](https://github.com/channel-io/bezier-react/pull/2778)) by @timok1m

## 3.6.1

### Patch Changes

- Adjust CSS specificity to ensure Japanese font is properly applied. ([#2776](https://github.com/channel-io/bezier-react/pull/2776)) by @timok1m
...
- Add size prop to Checkbox component ([#2684](https://github.com/channel-io/bezier-react/pull/2684)) by @annie1229
...
- Ensure `dropdownZIndex` property of `Select` properly overrides `Overlay` z-index ([#2621](https://github.com/channel-io/bezier-react/pull/2621)) by @j-nary
