...
describe('Select Test >', () => {
  ...
  describe('Trigger text style >', () => {
    it('shows default text color', () => {
      ...
      expect(triggerText).toHaveStyle('color: var(--txt-black-darkest);')
    })
    ...
    it('shows given text color', () => {
      ...
      expect(triggerText).toHaveStyle('color: var(--bgtxt-green-normal);')
    })
    ...
    it('shows placeholder text color if content is empty', () => {
      ...
      expect(triggerText).toHaveStyle('color: var(--txt-black-dark);')
    })
  })
