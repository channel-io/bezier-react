...
const label = createIconLabel('SvgHandThumbupFilled')
function SvgHandThumbupFilled(props: SVGProps<SVGSVGElement>) {
  const Svg = (
    <svg
      width="1em"
      height="1em"
...
export default createBezierIcon(SvgHandThumbupFilled)
