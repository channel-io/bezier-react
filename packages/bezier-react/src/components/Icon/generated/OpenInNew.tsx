...
const label = createIconLabel('SvgOpenInNew')
function SvgOpenInNew(props: SVGProps<SVGSVGElement>) {
  const Svg = (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M20.808 8.588C21 8.364 21 7.88 21 6.91V4.6c0-.56 0-.84-.109-1.054a1 1 0 0 0-.437-.437C20.24 3 19.96 3 19.4 3h-2.31c-.97 0-1.454 0-1.678.192a.8.8 0 0 0-.278.67c.023.295.366.638 1.051 1.323l.608.608-5 5a1 1 0 0 0 1.414 1.414l5-5 .608.608c.685.685 1.028 1.028 1.322 1.051a.8.8 0 0 0 .671-.278Z"
      />
    </svg>
  )
