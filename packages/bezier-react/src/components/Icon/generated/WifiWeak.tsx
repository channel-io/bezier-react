...
const label = createIconLabel('SvgWifiWeak')
function SvgWifiWeak(props: SVGProps<SVGSVGElement>) {
  const Svg = (
    <svg
      width="1em"
      height="1em"
