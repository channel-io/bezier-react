...
const label = createIconLabel('SvgAppCheck')
function SvgAppCheck(props: SVGProps<SVGSVGElement>) {
  const Svg = (
    <svg
      width="1em"
      height="1em"
