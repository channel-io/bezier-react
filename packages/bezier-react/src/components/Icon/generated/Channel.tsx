...
const label = createIconLabel('SvgChannel')
function SvgChannel(props: SVGProps<SVGSVGElement>) {
  const Svg = (
    <svg
      width="1em"
      height="1em"
