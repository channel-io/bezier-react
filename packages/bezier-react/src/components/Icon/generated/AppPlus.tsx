...
const label = createIconLabel('SvgAppPlus')
function SvgAppPlus(props: SVGProps<SVGSVGElement>) {
  const Svg = (
    <svg
      width="1em"
      height="1em"
