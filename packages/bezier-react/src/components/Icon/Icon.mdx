...
```tsx
<Icon source={ArrowLeftIcon} color="bgtxt-blue-normal" />
```
...
```tsx
<Icon source={ArrowLeftIcon} size={IconSize.S} />
```
...
- [Integration with Figma](https://github.com/channel-io/bezier-react/tree/main/packages/bezier-figma-plugin)
