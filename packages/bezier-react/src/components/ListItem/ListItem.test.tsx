...
describe('ListItem', () => {
  ...
  describe('should render correct height according to "size"', () => {
    it('size S', () => {
      renderComponent({ content: 'test', leftIcon: <Icon source={CheckIcon} />, size: ListItemSize.S })
    ...
    it('size M', () => {
      renderComponent({ content: 'test', leftIcon: <Icon source={CheckIcon} />, size: ListItemSize.M })
      const rendered = getDocument().querySelector(`div[data-testid=${LIST_ITEM_TEST_ID}]`)
      if (rendered) {
        const style = getWindow().getComputedStyle(rendered)
    ...
    it('size L', () => {
      renderComponent({ content: 'test', leftIcon: <Icon source={CheckIcon} />, size: ListItemSize.L })
      const rendered = getDocument().querySelector(`div[data-testid=${LIST_ITEM_TEST_ID}]`)
      if (rendered) {
        const style = getWindow().getComputedStyle(rendered)
    ...
    it('size XL', () => {
      renderComponent({ content: 'test', leftIcon: <Icon source={CheckIcon} />, size: ListItemSize.XL })
      const rendered = getDocument().querySelector(`div[data-testid=${LIST_ITEM_TEST_ID}]`)
      if (rendered) {
        const style = getWindow().getComputedStyle(rendered)
