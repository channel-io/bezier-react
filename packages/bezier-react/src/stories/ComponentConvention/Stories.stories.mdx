...
<Canvas>
  ...
  <Story name="Button:Overview.CopyLink">
    <Button text="Copy Link" leftContent={LinkIcon} styleVariant={ButtonStyleVariant.Tertiary} colorVariant={ButtonColorVariant.MonochromeLight} />
  </Story>
  <Story name="Button:Overview.Jump">
    <Button text="Jump" leftContent={ArrowRightUpIcon} styleVariant={ButtonStyleVariant.Floating} />
  </Story>
</Canvas>
```
...
<Canvas>
  ...
  <Story name="Button:ButtonGroup.Actions">
    <Button leftContent={FaceSmileAddIcon} colorVariant={ButtonColorVariant.MonochromeDark} styleVariant={ButtonStyleVariant.Tertiary} />
    <Button leftContent={CommentIcon} colorVariant={ButtonColorVariant.MonochromeDark} styleVariant={ButtonStyleVariant.Tertiary} />
    <Button leftContent={EditIcon} colorVariant={ButtonColorVariant.MonochromeDark} styleVariant={ButtonStyleVariant.Tertiary} />
    <Button leftContent={MoreVerticalIcon} colorVariant={ButtonColorVariant.MonochromeDark} styleVariant={ButtonStyleVariant.Tertiary} />
    <Button active leftContent={SplitRightIcon} colorVariant={ButtonColorVariant.MonochromeDark} styleVariant={ButtonStyleVariant.Tertiary} />
  </Story>
</Canvas>
```
