...
import globalColor from '../../../bezier-tokens/src/global/color.json'
import lightThemeColor from '../../../bezier-tokens/src/semantic/light-theme/color.json'
import darkThemeColor from '../../../bezier-tokens/src/semantic/dark-theme/color.json'
