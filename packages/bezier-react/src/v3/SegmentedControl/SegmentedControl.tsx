  ...
  return (
    ...
    >
      <div
        style={
          {
            '--b-v3-segmented-control-width': cssDimension(width),
            '--b-v3-segmented-control-item-index': selectedItemIndex,
            '--b-v3-segmented-control-item-count': childrenArray.length,
            ...style,
